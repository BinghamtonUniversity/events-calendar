...
<ul id="events-calendar-list" style="left-index: 0px; font-family: Arial; font-weight: normal; list-style-type: none;" >

<?php
    foreach ($feed_events as $event) {
        $formatted_date = strftime('%b %e', strtotime($event->date));
        echo "<li class=\"events-calendar-event\" style=\"color: #999999; font-size: 12px; padding-right: 10px; font-family: Arial; font-weight: normal;\" ><strong>$formatted_date:</strong> <a style=\"color: #00694d; font-size: 12px; font-family: Arial; font-weight: normal;\" href=\"http://calendar.binghamton.edu/index.php/calendar/event/$event->permalink\">$event->title</a></li>";
    }
?>
